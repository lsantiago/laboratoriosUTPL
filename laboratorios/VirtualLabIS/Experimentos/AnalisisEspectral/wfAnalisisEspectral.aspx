                                                ...
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body text-center">
                                                        <div id="chart-line" style="width: 100%; height: 100%;">
                                                            <asp:Image ID="img1" runat="server" ImageUrl="~/VirtualLabIS/Varios/Archivos/Imagenes/Dinamica/EN/1_EN.jpg" Width="290px" Height="220px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tab-content" style="width: 100%; height: 252px;">
                                                    ...
                                                    <div class="tab-pane active" id="test1">
                                                            ...
                                                            <div class="form-horizontal" role="form">
                                                                <div class="form-group">
                                                                    <div class="col-sm-6 radio">
                                                                                                <label><asp:RadioButton ID="rbAnalisisElastico" runat="server" class="icheck" AutoPostBack="True" Checked="True" GroupName="gTipoAnalisis" />
                                                                            <asp:Label ID="lblAElastico" runat="server" Text="ANALISIS ELASTICO" class="label-radioButton"></asp:Label></label>
                                                                                          </div>
                                                                    <div class="col-sm-6 radio">
                                                                                                <label><asp:RadioButton ID="rbAnalisisInelastico" runat="server" GroupName="gTipoAnalisis" class="icheck" AutoPostBack="True" />
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <hr />
                                                            <div id="chart-line" style="width: 100%; height: 100%;">
                                                                <asp:Image ID="img2" runat="server" ImageUrl="~/VirtualLabis/Varios/Archivos/Imagenes/Dinamica/ES/6_ES.jpg" Width="290px" Height="190px" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- END TEST1 FORM -->
                                                    ...
                                                    <div class="tab-pane" id="test2">
                                                        <div class="col-md-7">
                                                            <div class="form-horizontal" role="form">
                                                                <div class="form-group">
                                                                    <div class="col-sm-6 radio">
                                                                        <label><asp:RadioButton ID="rbCargaSinusoidal" runat="server" class="icheck" AutoPostBack="True" Checked="True" GroupName="gTipoAnalisis" />
                                                                            <asp:Label ID="lblCargaSinusoidal" runat="server" Text="FUNCION DE CARGA SINUSOIDAL" class="label-radioButton"></asp:Label></label>
                                                                    </div>
                                                                    <div class="col-sm-6 radio">
                                                                        <label><asp:RadioButton ID="rbAcelerograma" runat="server" GroupName="gTipoAnalisis" class="icheck" AutoPostBack="True" />
                                                                ...
                                                                <div id="tevalue0">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-3">
                                                                                <asp:TextBox ID="tbCargaMaxima" runat="server" class="form-control"></asp:TextBox>
                                                                            </div>

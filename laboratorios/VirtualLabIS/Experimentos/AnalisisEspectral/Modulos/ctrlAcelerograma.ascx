...
<div class="form-group">
    <div class="col-sm-7">
        ...
        <div class="form-group">
            <div class="col-sm-12">
            <asp:Label ID="lblMessagesUploadFileSismoX" runat="server" class="control-label" Font-Bold="True" ForeColor="Red"></asp:Label>
                </div>
        </div>
        <div class="form-group">
            <div class="col-sm-12">
            <asp:Label ID="lblNoteAcelerograma" runat="server" class="control-label" Font-Bold="True" ForeColor="Red"></asp:Label>
                </div>
        </div>
    </div>
    <div class="col-sm-5">

...
#Region "EVENTOS PROTEGIDOS"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Protected Sub ibtnRun_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnRun.Click
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Protected Sub ibtnLoadAce_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnLoadAce.Click
        Call CargarFile()
    End Sub
    ''' <summary>
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Protected Sub ibtnDescRmax_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnDescRmax.Click
...
#Region "DESCARGAR RESULTADOS"
    ...
    Protected Sub btnDownResul1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnDownResul1.Click, _
       btnDownResul2.Click, _
       btnDownResul3.Click, _
       btnDownResul4.Click, _
       btnDownResul5.Click, _
       btnDownResul6.Click, _
       btnDownResul7.Click
        nserie1Gtool1 = ViewState("ns1")
        nserieAS1Gtool1 = ViewState("nsAS1")
        MGDesp = Session("MGDespS") : MGVelo = Session("MGVeloS") : MGAce = Session("MGAceS") : MGForce = Session("MGForceS") : MGFvsD = Session("MGFvsDS")

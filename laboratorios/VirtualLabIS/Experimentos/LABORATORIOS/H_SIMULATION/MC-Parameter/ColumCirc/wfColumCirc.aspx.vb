...
Namespace VirtualLabIS.VLEE
    Partial Class VirtualLabIS_Experimentos_LABORATORIOS_H_SIMULATION_MC_Parameter_ColumCirc_wfColumCirc
...
#Region "Configuracion de gráficos"
        ...
        Private Sub establecerPropCtrlGraficos()
            ' GRÁFICA NÚMERO#1   "ANÁLISIS MOMENTO CURVATURA"
            CrearGraficasXYChart(60, 5, 250, 250, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, arrTextoEjes(idIdioma, 0), "Arial", 10, 0, 1, arrTextoEjes(idIdioma, 1), "Arial", 10, 0, 1, XYChart_Grafica_MomentoCurvatura)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "Φy (1/m)", "Arial", 10, 0, 1, "<*block*><*size=13*> ε<*sub*>y<*/*> / D (1/m)", "Arial", 10, 0, 1, XYChart_Grafica_EstimCurvaturaFluencia)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, arrTextoEjes(idIdioma, 2), "Arial", 10, 0, 1, arrTextoEjes(idIdioma, 3), "Arial", 10, 0, 1, XYChart_Grafica_ResistenciaRigidez)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*>I<*sub*><*size=10*>cr<*/*> / I<*sub*><*size=10*>g<*/*> ", "Arial", 10, 0, 1, " ρ (%)", "Arial", 10, 0, 1, XYChart_Grafica_InerciaGruesa_Agrietada)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*><*size=13*> ε<*sub*>c<*/*>", "Arial", 10, 0, 1, "DΦ", "Arial", 10, 0, 1, XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_EC)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*><*size=13*> ε<*sub*>s<*/*>", "Arial", 10, 0, 1, "DΦ", "Arial", 10, 0, 1, XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_ES)
...
#End Region
        ...
        Private Sub subAsignarIdiomaACtrls()
            ...
            lblSectionGraf.Text = GetLocalResourceObject("lblSectionGraf.Text").ToString()
            lblNumSections.Text = GetLocalResourceObject("lblNumSections.Text").ToString()
            ...
            lblCoverMain.Text = GetLocalResourceObject("lblCoverMain.Text").ToString()
            lblDiamMain.Text = GetLocalResourceObject("lblDiamMain.Text").ToString()
            lblNumMainBars.Text = GetLocalResourceObject("lblNumMainBars.Text").ToString()
            lblDiamTrans.Text = GetLocalResourceObject("lblDiamTrans.Text").ToString()
            lblSpacingTrans.Text = GetLocalResourceObject("lblSpacingTrans.Text").ToString()
            lblTypeTrans.Text = GetLocalResourceObject("lblTypeTrans.Text").ToString()
            ...
            lblFyLon.Text = GetLocalResourceObject("lblFyLon.Text").ToString()
        ...
        Sub obtenerDatos()
            ...
            Pfile_in(1, 1) = Me.txtdiameter1.Text   ' section diameter (mm)
            Pfile_in(2, 1) = Me.txtfc1.Text         ' concrete compressive strength (MPa)
            Pfile_in(3, 1) = Me.txtFyLong1.Text      ' long steel yielding stress (MPa)
            Pfile_in(4, 1) = Me.txtSteelRatio1.Text       ' steel hardening ratio
            Pfile_in(5, 1) = Me.txtFyTrans1.Text       ' transverse steel yielding stress (MPa)
            Pfile_in(6, 1) = CDbl(Me.txtShearSpan1.Text) / 1000        ' shear span (m)
            Pfile_in(7, 1) = Me.txtAxialLoad1.Text      ' Carga axial (kN)
            Pfile_in(8, 1) = Me.txtNumMain1.Text         ' # bars of main reiforcement
            Pfile_in(9, 1) = Me.txtDiamMain1.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 1) = Me.txtpacingTrans1.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 1) = Me.txtDiamTrans1.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 1) = Me.ddTipo1.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 1) = Me.txtcoverMain1.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 1) = "uniaxial" ' ductility mode

            Pfile_in(1, 2) = Me.txtdiameter2.Text       ' section diameter (mm)
            Pfile_in(2, 2) = Me.txtfc2.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 2) = Me.txtFyLong2.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 2) = Me.txtSteelRatio2.Text       ' steel hardening ratio
            Pfile_in(5, 2) = Me.txtFyTrans2.Text       ' transverse steel yielding stress (MPa)
            Pfile_in(6, 2) = CDbl(Me.txtShearSpan2.Text) / 1000         ' shear span (m)
            Pfile_in(7, 2) = Me.txtAxialLoad2.Text      ' Carga axial (kN)
            Pfile_in(8, 2) = Me.txtNumMain2.Text         ' # bars of main reiforcement
            Pfile_in(9, 2) = Me.txtDiamMain2.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 2) = Me.txtpacingTrans2.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 2) = Me.txtDiamTrans2.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 2) = Me.ddTipo2.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 2) = Me.txtcoverMain2.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 2) = "uniaxial" ' ductility mode

            Pfile_in(1, 3) = Me.txtdiameter3.Text       ' section diameter (mm)
            Pfile_in(2, 3) = Me.txtfc3.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 3) = Me.txtFyLong3.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 3) = Me.txtSteelRatio3.Text       ' steel hardening ratio
            Pfile_in(5, 3) = Me.txtFyTrans3.Text       ' transverse steel yielding stress (MPa)
            Pfile_in(6, 3) = CDbl(Me.txtShearSpan3.Text) / 1000         ' shear span (m)
            Pfile_in(7, 3) = Me.txtAxialLoad3.Text      ' Carga axial (kN)
            Pfile_in(8, 3) = Me.txtNumMain3.Text         ' # bars of main reiforcement
            Pfile_in(9, 3) = Me.txtDiamMain3.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 3) = Me.txtpacingTrans3.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 3) = Me.txtDiamTrans3.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 3) = Me.ddTipo3.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 3) = Me.txtcoverMain3.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 3) = "uniaxial" ' ductility mode

            Pfile_in(1, 4) = Me.txtdiameter4.Text       ' section diameter (mm)
            Pfile_in(2, 4) = Me.txtfc4.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 4) = Me.txtFyLong4.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 4) = Me.txtSteelRatio4.Text       ' steel hardening ratio
            Pfile_in(5, 4) = Me.txtFyTrans4.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 4) = Me.txtAxialLoad4.Text      ' Carga axial (kN)
            Pfile_in(8, 4) = Me.txtNumMain4.Text         ' # bars of main reiforcement
            Pfile_in(9, 4) = Me.txtDiamMain4.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 4) = Me.txtpacingTrans4.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 4) = Me.txtDiamTrans4.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 4) = Me.ddTipo4.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 4) = Me.txtcoverMain4.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 4) = "uniaxial" ' ductility mode

            Pfile_in(1, 5) = Me.txtdiameter5.Text       ' section diameter (mm)
            Pfile_in(2, 5) = Me.txtfc5.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 5) = Me.txtFyLong5.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 5) = Me.txtSteelRatio5.Text       ' steel hardening ratio
            Pfile_in(5, 5) = Me.txtFyTrans5.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 5) = Me.txtAxialLoad5.Text      ' Carga axial (kN)
            Pfile_in(8, 5) = Me.txtNumMain5.Text         ' # bars of main reiforcement
            Pfile_in(9, 5) = Me.txtDiamMain5.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 5) = Me.txtpacingTrans5.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 5) = Me.txtDiamTrans5.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 5) = Me.ddTipo5.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 5) = Me.txtcoverMain5.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 5) = "uniaxial" ' ductility mode

            Pfile_in(1, 6) = Me.txtdiameter6.Text       ' section diameter (mm)
            Pfile_in(2, 6) = Me.txtfc6.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 6) = Me.txtFyLong6.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 6) = Me.txtSteelRatio6.Text       ' steel hardening ratio
            Pfile_in(5, 6) = Me.txtFyTrans6.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 6) = Me.txtAxialLoad6.Text      ' Carga axial (kN)
            Pfile_in(8, 6) = Me.txtNumMain6.Text         ' # bars of main reiforcement
            Pfile_in(9, 6) = Me.txtDiamMain6.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 6) = Me.txtpacingTrans6.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 6) = Me.txtDiamTrans6.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 6) = Me.ddTipo6.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 6) = Me.txtcoverMain6.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 6) = "uniaxial" ' ductility mode

            Pfile_in(1, 7) = Me.txtdiameter7.Text       ' section diameter (mm)
            Pfile_in(2, 7) = Me.txtfc7.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 7) = Me.txtFyLong7.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 7) = Me.txtSteelRatio7.Text       ' steel hardening ratio
            Pfile_in(5, 7) = Me.txtFyTrans7.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 7) = Me.txtAxialLoad7.Text      ' Carga axial (kN)
            Pfile_in(8, 7) = Me.txtNumMain7.Text         ' # bars of main reiforcement
            Pfile_in(9, 7) = Me.txtDiamMain7.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 7) = Me.txtpacingTrans7.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 7) = Me.txtDiamTrans7.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 7) = Me.ddTipo7.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 7) = Me.txtcoverMain7.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 7) = "uniaxial" ' ductility mode

            Pfile_in(1, 8) = Me.txtdiameter8.Text       ' section diameter (mm)
            Pfile_in(2, 8) = Me.txtfc8.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 8) = Me.txtFyLong8.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 8) = Me.txtSteelRatio8.Text       ' steel hardening ratio
            Pfile_in(5, 8) = Me.txtFyTrans8.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 8) = Me.txtAxialLoad8.Text      ' Carga axial (kN)
            Pfile_in(8, 8) = Me.txtNumMain8.Text         ' # bars of main reiforcement
            Pfile_in(9, 8) = Me.txtDiamMain8.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 8) = Me.txtpacingTrans8.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 8) = Me.txtDiamTrans8.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 8) = Me.ddTipo8.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 8) = Me.txtcoverMain8.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 8) = "uniaxial" ' ductility mode

            Pfile_in(1, 9) = Me.txtdiameter9.Text       ' section diameter (mm)
            Pfile_in(2, 9) = Me.txtfc9.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 9) = Me.txtFyLong9.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 9) = Me.txtSteelRatio9.Text       ' steel hardening ratio
            Pfile_in(5, 9) = Me.txtFyTrans9.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 9) = Me.txtAxialLoad9.Text      ' Carga axial (kN)
            Pfile_in(8, 9) = Me.txtNumMain9.Text         ' # bars of main reiforcement
            Pfile_in(9, 9) = Me.txtDiamMain9.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 9) = Me.txtpacingTrans9.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 9) = Me.txtDiamTrans9.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 9) = Me.ddTipo9.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 9) = Me.txtcoverMain9.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 9) = "uniaxial" ' ductility mode

            Pfile_in(1, 10) = Me.txtdiameter10.Text       ' section diameter (mm)
            Pfile_in(2, 10) = Me.txtfc10.Text        ' concrete compressive strength (MPa)
            Pfile_in(3, 10) = Me.txtFyLong10.Text       ' long steel yielding stress (MPa)
            Pfile_in(4, 10) = Me.txtSteelRatio10.Text       ' steel hardening ratio
            Pfile_in(5, 10) = Me.txtFyTrans10.Text       ' transverse steel yielding stress (MPa)
            ...
            Pfile_in(7, 10) = Me.txtAxialLoad10.Text      ' Carga axial (kN)
            Pfile_in(8, 10) = Me.txtNumMain10.Text         ' # bars of main reiforcement
            Pfile_in(9, 10) = Me.txtDiamMain10.Text        'diameter bars of main reiforcement (mm)
            Pfile_in(10, 10) = Me.txtpacingTrans10.Text       ' spacing of transverse reinforcement (mm)
            Pfile_in(11, 10) = Me.txtDiamTrans10.Text       ' diameter of transverse reinforcement (mm)
            Pfile_in(12, 10) = Me.ddTipo10.SelectedValue.ToString   ' type of transverse reinforcement (spirals or hoops)
            Pfile_in(13, 10) = Me.txtcoverMain10.Text       ' cover up main reinforcement rebar centre(mm)
            Pfile_in(14, 10) = "uniaxial" ' ductility mode
        ...
        Sub CargarEjemplo()
            ...
            Me.txtNumberSections.Text = 3 'Number of sections to analise
            Me.txtdiameter1.Text = 600   ' section diameter (mm)
            ...
            Me.txtShearSpan1.Text = 2500        ' shear span (m)
            Me.txtAxialLoad1.Text = 900      ' Carga axial (kN)
            Me.txtNumMain1.Text = 8         ' # bars of main reiforcement
            Me.txtDiamMain1.Text = 22        'diameter bars of main reiforcement (mm)
            Me.txtpacingTrans1.Text = 150      ' spacing of transverse reinforcement (mm)
            Me.txtDiamTrans1.Text = 10       ' diameter of transverse reinforcement (mm)
            Me.txtcoverMain1.Text = 50     ' cover up main reinforcement rebar centre(mm)

            Me.txtdiameter2.Text = 600   ' section diameter (mm)
            ...
            Me.txtShearSpan2.Text = 2500        ' shear span (m)
            Me.txtAxialLoad2.Text = 900      ' Carga axial (kN)
            Me.txtNumMain2.Text = 12         ' # bars of main reiforcement
            Me.txtDiamMain2.Text = 22        'diameter bars of main reiforcement (mm)
            Me.txtpacingTrans2.Text = 150      ' spacing of transverse reinforcement (mm)
            Me.txtDiamTrans2.Text = 10       ' diameter of transverse reinforcement (mm)
            Me.txtcoverMain2.Text = 50     ' cover up main reinforcement rebar centre(mm)

            Me.txtdiameter3.Text = 600   ' section diameter (mm)
            ...
            Me.txtShearSpan3.Text = 2500        ' shear span (m)
            Me.txtAxialLoad3.Text = 900      ' Carga axial (kN)
            Me.txtNumMain3.Text = 16         ' # bars of main reiforcement
            Me.txtDiamMain3.Text = 22        'diameter bars of main reiforcement (mm)
            Me.txtpacingTrans3.Text = 150      ' spacing of transverse reinforcement (mm)
            Me.txtDiamTrans3.Text = 10       ' diameter of transverse reinforcement (mm)
            Me.txtcoverMain3.Text = 50     ' cover up main reinforcement rebar centre(mm)            
        ...
        Sub subPresentarResultados()
            ...
            For n As Integer = 1 To NumSections  'nsections
                objVLEE_AMC.readnsection(n)
                objVLEE_AMC.readinput_MC_circol_Parameter(Pfile_in)
        ...
        Sub Resultados()
            ...
            Dim etiquetasS(,) As String = {{"Cuantía de Acero Longitudinal", _
                                        ...
                                        {"Longitudinal steel ratio", _
                                          ...
                                          """c"" is the neutral axis depth" & Chr(13) & """ec"" is the concrete strain" & Chr(13) & """es"" is the steel strain" & Chr(13) & """Mv"" is the moment demand to develop shear strength computed with the modified UCSD model" & Chr(13) & " Curvature(1/m)	Moment (kN.m)	c (m)		ec		es		Mv(kN-m)"}}
        ...
        Sub subGraficar()
            ...
            If NumSections >= 1 Then
                ...
                lineMC = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC, colores(0), "Section 1")
            ...
            lineBilineal = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal, colores(0))
            ...
            If NumSections >= 2 Then
                ...
                lineMC2 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC2, colores(1), "Section 2")
            ...
            lineBilineal2 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal2, colores(1))
            ...
            If NumSections >= 3 Then
                ...
                lineMC3 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC3, colores(2), "Section 3")
            ...
            lineBilineal3 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal3, colores(2))
            ...
            If NumSections >= 4 Then
                ...
                lineMC4 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC4, colores(3), "Section 4")
            ...
            lineBilineal4 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal4, colores(3))
            ...
            If NumSections >= 5 Then
                ...
                lineMC5 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC5, colores(4), "Section 5")
            ...
            lineBilineal5 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal5, colores(4))
            ...
            If NumSections >= 6 Then
                ...
                lineMC6 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC6, colores(5), "Section 6")
            ...
            lineBilineal6 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal6, colores(5))
            ...
            If NumSections >= 7 Then
                ...
                lineMC7 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC7, colores(6), "Section7")
            ...
            lineBilineal7 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal7, colores(6))
            ...
            If NumSections >= 8 Then
                ...
                lineMC8 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC8, colores(7), "Section 8")
            ...
            lineBilineal8 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal8, colores(7))
            ...
            If NumSections >= 9 Then
                ...
                lineMC9 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC9, colores(8), "Section 9")
            ...
            lineBilineal9 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal9, colores(8))
            ...
            If NumSections >= 10 Then
                ...
                lineMC10 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineMC10, colores(9), "Section 10")
            ...
            lineBilineal10 = XYChart_Grafica_MomentoCurvatura.addLineLayer(arrYLineBilineal10, colores(9))
        ...
        '    startInfo = New System.Diagnostics.ProcessStartInfo("C:\Inetpub\wwwroot\VLEE\Temp\Exp\Pushover\exec.bat")

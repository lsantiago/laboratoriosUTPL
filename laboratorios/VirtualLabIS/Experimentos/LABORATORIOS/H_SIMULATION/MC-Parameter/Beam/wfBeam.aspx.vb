...
#Region "Configuracion de gráficos"
        ...
        Private Sub establecerPropCtrlGraficos()
            ...
            '' GRÁFICO NÚMERO#4   "RELACIÓN ENTRE INERCIA GRUESA / INERCIA AGRIETADA Y LA CUANTÍA DE ACERO"
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*>I<*sub*><*size=10*>cr<*/*> / I<*sub*><*size=10*>g<*/*> ", "Arial", 10, 0, 1, " ρ (%)", "Arial", 10, 0, 1, XYChart_Grafica_InerciaGruesa_Agrietada)
            'XYChart_Grafica_InerciaGruesa_Agrietada.addLegend(50, 50, False, "Arial Bold", 9).setBackground(Chart.Transparent)

            '' GRÁFICA NÚMERO#1   "ANÁLISIS MOMENTO CURVATURA"
            'CrearGraficasXYChart(60, 5, 250, 250, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "MOMENT(kN-m)", "Arial", 10, 0, 1, "CURVATURE (1/m)", "Arial", 10, 0, 1, XYChart_Grafica_MomentoCurvatura)
            'legendBox = XYChart_Grafica_MomentoCurvatura.addLegend(intAddLegend_Coord_x, intAddLegend_Coord_y, bolAddLegend_Bool, strAddLegend_Font, intAddLegend_FontSize)
            'legendBox.setBackground(Chart.Transparent)
            '' GRÁFICA NÚMERO#2   "ESTIMACIÓN DE CURVATURA DE FLUENCIA"
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "Φy (1/m)", "Arial", 10, 0, 1, "ε<*sub*>y<*/*> / D (1/m)", "Arial", 10, 0, 1, XYChart_Grafica_EstimCurvaturaFluencia)
            'XYChart_Grafica_EstimCurvaturaFluencia.addLegend(50, 50, False, "Times New Roman Bold Italic", 12).setBackground(Chart.Transparent)
            '' GRÁFICO NÚMERO#3   "RELACIÓN ENTRE RESISTENCIA Y RIGIDEZ"
            ''CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "FLEXURAL STRENGTH  My (kN/m)", "Arial", 10, 0, 1, "CRACKED FLEXURAL STIFFNESS Elcr (kN/m<*super*>2)", "Arial", 10, 0, 1, XYChart_Grafica_ResistenciaRigidez)
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "FLEXURAL STRENGTH  My (kN-m)", "Arial", 10, 0, 1, "CRACKED FLEXURAL STIFFNESS Elcr (kN/m)", "Arial", 10, 0, 1, XYChart_Grafica_ResistenciaRigidez)
            'XYChart_Grafica_ResistenciaRigidez.addLegend(50, 50, False, "Arial Bold", 9).setBackground(Chart.Transparent)
            '' GRÁFICO NÚMERO#4   "RELACIÓN ENTRE INERCIA GRUESA / INERCIA AGRIETADA Y LA CUANTÍA DE ACERO"
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*>I<*sub*><*size=10*>cr<*/*> / I<*sub*><*size=10*>g<*/*> ", "Arial", 10, 0, 1, " ρ (%)", "Arial", 10, 0, 1, XYChart_Grafica_InerciaGruesa_Agrietada)
            'XYChart_Grafica_InerciaGruesa_Agrietada.addLegend(50, 50, False, "Arial Bold", 9).setBackground(Chart.Transparent)
            '' GRÁFICO NÚMERO#5   "RELACIÓN DE LA INERCIA GRUESA / INERCIA AGRIETADA REAL Y LA INERCIA GRUESA / INERCIA AGRIETADA CALCULADA"
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*>I<*sub*><*size=10*>cr<*/*> / I<*sub*><*size=10*>g<*/*> from M-C", "Arial", 10, 0, 1, "<*block*>I<*sub*><*size=10*>cr<*/*> / I<*sub*><*size=10*>g<*/*> Kowalsky", "Arial", 10, 0, 1, XYChart_Grafica_InercGruesAgriet_Real_Calculada)
            ...
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*><*size=13*> ε<*sub*>c<*/*>", "Arial", 10, 0, 1, "DΦ", "Arial", 10, 0, 1, XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_EC)
            'XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_EC.addLegend(380, 85, False, "Arial Bold", 9).setBackground(Chart.Transparent)
            '' GRÁFICA NÚMERO#7 "RELACIÓN ENTRE DEFORMACIÓN UNITARIA DEL ACERO Y CURVATURA" Es        ''' </summary>
            'CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HCCCCCC, &HCCCCCC, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*><*size=13*> ε<*sub*>s<*/*>", "Arial", 10, 0, 1, "DΦ", "Arial", 10, 0, 1, XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_ES)
            'XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_ES.addLegend(380, 85, False, "Arial Bold", 9).setBackground(Chart.Transparent)

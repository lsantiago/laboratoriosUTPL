...
Namespace VirtualLabIS.VLEE
    Partial Class VirtualLabIS_Experimentos_LABORATORIOS_H_SIMULATION_MC_Parameter_ColumnRect_wfColumRect
...
#Region "Variables Globales"
        ...
        Dim figura1(10, 4) As Object
        Dim figura2(10, 4) As Object
        Dim figura3(10, 4) As Object
        Dim figura4(10, 50, 4) As Object
        Dim figura5(10, 50, 4) As Object
...
#Region "Configuracion de gráficos"
        ...
        Private Sub establecerPropCtrlGraficos()
            ' GRÁFICA NÚMERO#1   "ANÁLISIS MOMENTO CURVATURA"
            CrearGraficasXYChart(60, 5, 250, 250, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, arrTextoEjes(idIdioma, 0), "Arial", 9, 0, 1, arrTextoEjes(idIdioma, 1), "Arial", 9, 0, 1, XYChart_Grafica_MomentoCurvatura)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "Φy (1/m)", "Arial", 9, 0, 1, "<*block*><*size=13*> ε<*sub*>y<*/*> / D (1/m)", "Arial", 9, 0, 1, XYChart_Grafica_EstimCurvaturaFluencia)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, arrTextoEjes(idIdioma, 2), "Arial", 9, 0, 1, arrTextoEjes(idIdioma, 3), "Arial", 9, 0, 1, XYChart_Grafica_ResistenciaRigidez)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*>I<*sub*><*size=10*>cr<*/*> / I<*sub*><*size=10*>g<*/*> ", "Arial", 9, 0, 1, " ρ (%)", "Arial", 9, 0, 1, XYChart_Grafica_InerciaGruesa_Agrietada)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*><*size=13*> ε<*sub*>c<*/*>", "Arial", 9, 0, 1, "DΦ", "Arial", 9, 0, 1, XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_EC)
            ...
            CrearGraficasXYChart(60, 40, 320, 300, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, "<*block*><*size=13*> ε<*sub*>s<*/*>", "Arial", 9, 0, 1, "DΦ", "Arial", 9, 0, 1, XYChart_Grafica_RelacionDeformacionUnitariaCurvatura_ES)
...
#End Region
        ...
        Private Sub subAsignarIdiomaACtrls()
            ...
            lblBiaxialAngle.Text = GetLocalResourceObject("lblBiaxialAngle.Text").ToString()
            lblCoverLateral.Text = GetLocalResourceObject("lblCoverLateral.Text").ToString()
            lblCoverTopBottom.Text = GetLocalResourceObject("lblCoverTopBottom.Text").ToString()
            ...
            lblDiamTopBottom.Text = GetLocalResourceObject("lblDiamTopBottom.Text").ToString()
            ...
            lblNumBars.Text = GetLocalResourceObject("lblNumBars.Text").ToString()
            lblNumBarsLateral.Text = GetLocalResourceObject("lblNumBarsLateral.Text").ToString()
            lblNumLegsX.Text = GetLocalResourceObject("lblNumLegsX.Text").ToString()
            lblNumLegsY.Text = GetLocalResourceObject("lblNumLegsY.Text").ToString()
            'lblNumSec.Text = GetLocalResourceObject("lblNumSec.Text").ToString()
            lblNumSecciones.Text = GetLocalResourceObject("lblNumSecciones.Text").ToString()
            'lblResults.Text = GetLocalResourceObject("lblResults.Text").ToString()
            'lblRotuloGrafico.Text = GetLocalResourceObject("lblRotuloGrafico.Text").ToString()
            ...
            'lblTituloGenerel.Text = GetLocalResourceObject("lblTituloGenerel.Text").ToString()
        ...
        Sub obtenerDatos()
            ...
            Pfile_in(8, 1) = Me.txtAxialLoad1.Text       ' Carga axial (kN)
            Pfile_in(9, 1) = Me.txtBarsTopBottom1.Text          ' # bars of top and bottom steel
            Pfile_in(10, 1) = Me.txtDiamTopBottom1.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 1) = Me.txtNumBarsLateral1.Text          ' # bars of lateral steel
            Pfile_in(12, 1) = Me.txtDiamLateral1.Text          ' diameter bars of lateral steel
            Pfile_in(13, 1) = Me.txtBiaxial1.Text          ' # biaxial angle
            ...
            Pfile_in(8, 2) = Me.txtAxialLoad2.Text       ' Carga axial (kN)
            Pfile_in(9, 2) = Me.txtBarsTopBottom2.Text          ' # bars of top and bottom steel
            Pfile_in(10, 2) = Me.txtDiamTopBottom2.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 2) = Me.txtNumBarsLateral2.Text          ' # bars of lateral steel
            Pfile_in(12, 2) = Me.txtDiamLateral2.Text          ' diameter bars of lateral steel
            Pfile_in(13, 2) = Me.txtBiaxial2.Text          ' # biaxial angle
            ...
            Pfile_in(8, 3) = Me.txtAxialLoad3.Text       ' Carga axial (kN)
            Pfile_in(9, 3) = Me.txtBarsTopBottom3.Text          ' # bars of top and bottom steel
            Pfile_in(10, 3) = Me.txtDiamTopBottom3.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 3) = Me.txtNumBarsLateral3.Text          ' # bars of lateral steel
            Pfile_in(12, 3) = Me.txtDiamLateral3.Text          ' diameter bars of lateral steel
            Pfile_in(13, 3) = Me.txtBiaxial3.Text          ' # biaxial angle
            ...
            Pfile_in(8, 4) = Me.txtAxialLoad4.Text       ' Carga axial (kN)
            Pfile_in(9, 4) = Me.txtBarsTopBottom4.Text          ' # bars of top and bottom steel
            Pfile_in(10, 4) = Me.txtDiamTopBottom4.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 4) = Me.txtNumBarsLateral4.Text          ' # bars of lateral steel
            Pfile_in(12, 4) = Me.txtDiamLateral4.Text          ' diameter bars of lateral steel
            Pfile_in(13, 4) = Me.txtBiaxial4.Text          ' # biaxial angle
            ...
            Pfile_in(8, 5) = Me.txtAxialLoad5.Text       ' Carga axial (kN)
            Pfile_in(9, 5) = Me.txtBarsTopBottom5.Text          ' # bars of top and bottom steel
            Pfile_in(10, 5) = Me.txtDiamTopBottom5.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 5) = Me.txtNumBarsLateral5.Text          ' # bars of lateral steel
            Pfile_in(12, 5) = Me.txtDiamLateral5.Text          ' diameter bars of lateral steel
            Pfile_in(13, 5) = Me.txtBiaxial5.Text          ' # biaxial angle
            ...
            Pfile_in(8, 6) = Me.txtAxialLoad6.Text       ' Carga axial (kN)
            Pfile_in(9, 6) = Me.txtBarsTopBottom6.Text          ' # bars of top and bottom steel
            Pfile_in(10, 6) = Me.txtDiamTopBottom6.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 6) = Me.txtNumBarsLateral6.Text          ' # bars of lateral steel
            Pfile_in(12, 6) = Me.txtDiamLateral6.Text          ' diameter bars of lateral steel
            Pfile_in(13, 6) = Me.txtBiaxial6.Text          ' # biaxial angle
            ...
            Pfile_in(8, 7) = Me.txtAxialLoad7.Text       ' Carga axial (kN)
            Pfile_in(9, 7) = Me.txtBarsTopBottom7.Text          ' # bars of top and bottom steel
            Pfile_in(10, 7) = Me.txtDiamTopBottom7.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 7) = Me.txtNumBarsLateral7.Text          ' # bars of lateral steel
            Pfile_in(12, 7) = Me.txtDiamLateral7.Text          ' diameter bars of lateral steel
            Pfile_in(13, 7) = Me.txtBiaxial7.Text          ' # biaxial angle
            ...
            Pfile_in(8, 8) = Me.txtAxialLoad8.Text       ' Carga axial (kN)
            Pfile_in(9, 8) = Me.txtBarsTopBottom8.Text          ' # bars of top and bottom steel
            Pfile_in(10, 8) = Me.txtDiamTopBottom8.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 8) = Me.txtNumBarsLateral8.Text          ' # bars of lateral steel
            Pfile_in(12, 8) = Me.txtDiamLateral8.Text          ' diameter bars of lateral steel
            Pfile_in(13, 8) = Me.txtBiaxial8.Text          ' # biaxial angle
            ...
            Pfile_in(8, 9) = Me.txtAxialLoad9.Text       ' Carga axial (kN)
            Pfile_in(9, 9) = Me.txtBarsTopBottom9.Text          ' # bars of top and bottom steel
            Pfile_in(10, 9) = Me.txtDiamTopBottom9.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 9) = Me.txtNumBarsLateral9.Text          ' # bars of lateral steel
            Pfile_in(12, 9) = Me.txtDiamLateral9.Text          ' diameter bars of lateral steel
            Pfile_in(13, 9) = Me.txtBiaxial9.Text          ' # biaxial angle
            ...
            Pfile_in(8, 10) = Me.txtAxialLoad10.Text       ' Carga axial (kN)
            Pfile_in(9, 10) = Me.txtBarsTopBottom10.Text          ' # bars of top and bottom steel
            Pfile_in(10, 10) = Me.txtDiamTopBottom10.Text          ' diameter bars of top and bottom steel
            Pfile_in(11, 10) = Me.txtNumBarsLateral10.Text          ' # bars of lateral steel
            Pfile_in(12, 10) = Me.txtDiamLateral10.Text          ' diameter bars of lateral steel
            Pfile_in(13, 10) = Me.txtBiaxial10.Text          ' # biaxial angle
        ...
        Sub CargarEjemplo()
            ...
            Me.txtBase1.Text = 600       ' section base (mm)
            Me.txtHeight1.Text = 600        ' section height (mm)
            ...
            Me.txtShearSpan1.Text = 5000         ' shear span (m)
            Me.txtAxialLoad1.Text = 1000       ' Carga axial (kN)
            Me.txtBarsTopBottom1.Text = 8          ' # bars of top and bottom steel
            Me.txtDiamTopBottom1.Text = 16          ' diameter bars of top and bottom steel
            Me.txtNumBarsLateral1.Text = 4          ' # bars of lateral steel
            Me.txtDiamLateral1.Text = 16          ' diameter bars of lateral steel
            Me.txtBiaxial1.Text = 0          ' # biaxial angle
            ...
            Me.txtSpacingStirrups1.Text = 150        ' spacing of stirrups (mm)
            ...
            Me.txtBase2.Text = 600       ' section base (mm)
            Me.txtHeight2.Text = 600        ' section height (mm)
            ...
            Me.txtShearSpan2.Text = 5000         ' shear span (m)
            Me.txtAxialLoad2.Text = 1000       ' Carga axial (kN)
            Me.txtBarsTopBottom2.Text = 8          ' # bars of top and bottom steel
            Me.txtDiamTopBottom2.Text = 18          ' diameter bars of top and bottom steel
            Me.txtNumBarsLateral2.Text = 4          ' # bars of lateral steel
            Me.txtDiamLateral2.Text = 18          ' diameter bars of lateral steel
            Me.txtBiaxial2.Text = 0          ' # biaxial angle
            ...
            Me.txtSpacingStirrups2.Text = 150        ' spacing of stirrups (mm)
            ...
            Me.txtBase3.Text = 600       ' section base (mm)
            Me.txtHeight3.Text = 600        ' section height (mm)
            ...
            Me.txtShearSpan3.Text = 5000         ' shear span (m)
            Me.txtAxialLoad3.Text = 1000       ' Carga axial (kN)
            Me.txtBarsTopBottom3.Text = 8          ' # bars of top and bottom steel
            Me.txtDiamTopBottom3.Text = 22          ' diameter bars of top and bottom steel
            Me.txtNumBarsLateral3.Text = 4          ' # bars of lateral steel
            Me.txtDiamLateral3.Text = 22          ' diameter bars of lateral steel
            Me.txtBiaxial3.Text = 0          ' # biaxial angle
            ...
            Me.txtSpacingStirrups3.Text = 150        ' spacing of stirrups (mm)
        ...
        Sub subPresentarResultados()
            ...
            For n As Integer = 1 To NumSections  'nsections
                ...
                objVLEE_AMC.readinput_MC_reccol_Parameter(Pfile_in)
                objVLEE_AMC.MC_reccol()
            Next
            'resultados
        ...
        Sub Resultados()
            ...
            Dim etiquetasS(,) As String = {{"Cuantía de Acero Longitudinal", _
                                          ...
                                          "Curvatura de Primera Fluencia (kN-m)", _

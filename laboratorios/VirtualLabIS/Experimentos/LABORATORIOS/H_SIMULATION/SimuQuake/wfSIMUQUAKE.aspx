                                                            ...
                                                            <div class="form-group" style="padding-top: 15px;">
                                                                <div class="col-md-7">
                                                                    <div class="form-group">
                                                                        <asp:Label ID="lblNomSismo" runat="server" class="col-sm-8 control-label label-one" Text="NUMBER OF EARTHQUAKES TO BE SIMULATED"></asp:Label>
                                                                        <div class="col-sm-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <asp:Label ID="lblNumSimulaciones" runat="server" class="col-sm-8 control-label label-one" Text="NUMBER OF EARTHQUAKES TO BE SIMULATED"></asp:Label>
                                                                        <div class="col-sm-3">
                                                                ...
                                                                <div class="col-md-5">
                                                                    ...
                                                                    <div style="width: 100%; height: 191px;">
                                                                        <div class="image">
                                                                            <asp:Image ID="imgFig1" runat="server" ImageUrl="~/VirtualLabIS/Varios/Archivos/Imagenes/SIMUQUAKE/FigEarthquakeParameter-EN.gif" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>

...
Namespace VirtualLabIS.VLEE
    Partial Class VirtualLabIS_Experimentos_LABORATORIOS_H_SIMULATION_MC_Analysis_McColumnaRec_wfmColRec
...
#Region "Variables Globales"
        ...
        Dim XYChart_Grafica_MomentoCurvatura As XYChart = New XYChart(intAnchoGraficas - 50, intAltoGraficas, intColorFondo, intColorFondo, 0) 'XYChart para el primer gráfico
...
#Region "Configuracion de gráficos"
        ...
        Private Sub establecerPropCtrlGraficos()
            ' GRÁFICA NÚMERO#1   "ANÁLISIS MOMENTO CURVATURA"
            CrearGraficasXYChart(60, 5, 250, 200, &HFFFFFF, -1, -1, &HFFFFFF, &HFFFFFF, "", "Times New Roman Bold", 16, 0, 0, 0, arrTextoEjes(idIdioma, 0), "Arial", 10, 0, 1, arrTextoEjes(idIdioma, 1), "Arial", 10, 0, 1, XYChart_Grafica_MomentoCurvatura)
...
#End Region
        ...
        Private Sub subAsignarIdiomaACtrls()
            ...
            'lblTítuloGeneral.Text = GetLocalResourceObject("lblTítuloGeneral.Text").ToString()
            ...
            lblAngle.Text = GetLocalResourceObject("lblAngle.Text").ToString()
        ...
        Sub obtenerDatos()
            ...
            file_in(9) = Me.txtNumberTopBottom.Text
            file_in(10) = Me.txtDiamTopBottom.Text
            file_in(11) = Me.txtNumberLateral.Text
            file_in(12) = Me.txtDiamLateral.Text
            file_in(13) = Me.txtAngle.Text
            file_in(14) = Me.txtNumLegsX.Text
            file_in(15) = Me.txtNumberLegsY.Text
            file_in(16) = Me.txtDiamEstr.Text
            file_in(17) = Me.txtSpacingEstr.Text
            file_in(18) = Me.txtcoverTopBottom.Text
            file_in(19) = Me.txtCoverLateral.Text
            file_in(20) = Me.ddmode.SelectedValue.ToString

        End Sub

        Sub resultados()

            'Enviar datos a cajas de texto
            ...
            For i As Integer = 1 To 50
                strResultados = strResultados + CStr(Round(matriz(i, 1), 5)) & Chr(9) & Chr(9) & CStr(Round(matriz(i, 2), 5)) & Chr(9) & Chr(9) & CStr(Round(matriz(i, 3), 5)) & Chr(9) & Chr(9) & CStr(Round(matriz(i, 4), 5)) & Chr(9) & Chr(9) & CStr(Round(matriz(i, 5), 5)) & Chr(9) & Chr(9) & CStr(Round(matriz(i, 6), 5))
        ...
        Sub subPresentarResultados()
            objVLEE_AMC.readinput_MC_reccol(file_in)
        ...
        Protected Sub btnCargarEjemplo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCargarEjemplo.Click
            ...
            Me.txtAngle.Text = 0
            Me.txtNumberTopBottom.Text = 8
            Me.txtDiamTopBottom.Text = 22
            Me.txtNumberLateral.Text = 4
            Me.txtDiamLateral.Text = 22
            Me.txtNumberLegsY.Text = 2
            Me.txtNumLegsX.Text = 2
            Me.txtDiamEstr.Text = 10
            Me.txtSpacingEstr.Text = 150
            Me.txtShearSpan.Text = 2000
            Me.txtAxialLoad.Text = 1000

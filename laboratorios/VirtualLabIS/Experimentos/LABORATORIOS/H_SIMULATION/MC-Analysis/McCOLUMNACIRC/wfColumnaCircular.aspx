                                                ...
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body text-center">
                                                        <div id="chart-line" style="width: 100%; height: 100%;">
                                                            <asp:Image ID="FigMain" runat="server" ImageUrl="~/VirtualLabIS/Experimentos/LABORATORIOS/imagenes/Mc Analysis Circular.jpg" Width="290px" Height="220px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal" role="form">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-sm-8 control-label small label-one">
                                                                            # LONGITUDINAL REBARS</label>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <asp:Label ID="lblSpacingTransSteel" runat="server" Font-Bold="False" CssClass="Funcionalidad-datos-entrada"></asp:Label>
                                                                        <div class="col-sm-5">
                                                    ...
                                                    <div class="tab-pane" id="test2">
                                                        <div class="col-md-7">
                                                            <div class="form-horizontal" role="form">
                                                                ...
                                                                <div class="form-group">
                                                                    <asp:Label ID="lblLongRMX" runat="server" class="col-sm-9 control-label small label-one"></asp:Label>
                                                                    <div class="col-sm-3">
                                                ...
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body text-center">
                                                        <div id="chart-line" style="width: 100%; height: 270px;">
                                                            <chart:WebChartViewer ID="WebChartViewer1" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent"  Width="290px" Height="220px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="col-md-12 text-center">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <asp:Image ID="Image13" runat="server" class="col-sm-2" ImageUrl="../../Content/Images/Columna/Ecuaciones/ID_CuantiaAceroLongitudinalAMC.png" />
                                                                            <div class="col-sm-3">
                                                ...
                                                <div class="panel-group" id="accordion">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="collapseOne" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                                <p><asp:TextBox ID="txtresult" runat="server" Height="600px" TextMode="MultiLine" Width="800px" class="form-control"></asp:TextBox></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                ...
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body text-center">
                                                        <div style="width: 100%; height: 220px">
                                                            <div class="image">
                                                                <asp:Image ID="FigMain" runat="server" ImageUrl="~/VirtualLabIS/Experimentos/LABORATORIOS/imagenes/Mc Analysis Circular.jpg" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-horizontal" role="form">
                                                    <div class="tab-content">
                                                        <!-- BEGIN TEST1 FORM -->
                                                        <div class="tab-pane active" id="test1" style="padding-top: 5%; padding-bottom: 8%;">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="form-horizontal" role="form">
                                                                        ...
                                                                        <hr />
                                                                        <div style="width: 100%;">
                                                                            <div id="graphics0" style="width: 100%; height: 188px;">
                                                                                <div class="image">
                                                                                    <asp:Image ID="imgModeloConcreto" runat="server" />
                                                                                </div>
                                                                            </div>
                                                                            <div id="graphics1" style="width: 100%; height: 188px;">
                                                                                <div class="image">
                                                        ...
                                                        <div class="tab-pane" id="test3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4" style="padding-top: 12%; padding-bottom: 12%">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-4">

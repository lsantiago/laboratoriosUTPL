                                                ...
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body text-center">
                                                        <div id="chart-line" style="width: 100%; height: 100%;">
                                                            <asp:Image ID="FigMain" runat="server" ImageUrl="~/VirtualLabIS/Experimentos/LABORATORIOS/imagenes/Mc Analysis Viga.jpg" Width="290px" Height="220px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="test2">
                                                        <div class="col-md-7">
                                                            <div class="form-horizontal" role="form">
                                                                ...
                                                                <div class="form-group">
                                                                    <asp:Label ID="lblindEnd" runat="server" class="col-sm-9 control-label small label-one"></asp:Label>
                                                                    <div class="col-sm-3">
                                                            ...
                                                            <div class="form-horizontal" role="form">
                                                                ...
                                                                <div class="form-group">
                                                                    <div id="graphics0" class="col-sm-11">
                                                                        <asp:Image ID="imgModeloConcreto" runat="server" ImageUrl="../../../imagenes/concreto.jpg" Width="290px" Height="190px" />
                                                                    </div>
                                                                    <div id="graphics1" class="col-sm-11">
                                                                        <asp:Image ID="imgModeloAcero" runat="server" ImageUrl="../../../imagenes/acero.jpg" Width="290px" Height="190px" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

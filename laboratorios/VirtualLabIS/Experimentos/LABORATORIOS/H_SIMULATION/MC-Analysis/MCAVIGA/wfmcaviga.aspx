                                                            ...
                                                            <div class="form-horizontal" role="form">
                                                                ...
                                                                <div style="width: 100%; height: 100%;">
                                                                    <div id="graphics0" class="col-sm-11" style="padding-left: 0px">
                                                                        <asp:Image ID="imgModeloConcreto" runat="server" ImageUrl="../../../imagenes/concreto.jpg" Width="300px" Height="190px" />
                                                                    </div>
                                                                    <div id="graphics1" class="col-sm-11" style="padding-left: 0px">
                                                                        <asp:Image ID="imgModeloAcero" runat="server" ImageUrl="../../../imagenes/acero.jpg" Width="300px" Height="190px" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

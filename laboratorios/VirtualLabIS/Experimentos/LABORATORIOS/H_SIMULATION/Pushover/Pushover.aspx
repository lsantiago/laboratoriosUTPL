                                            ...
                                            <div class="col-md-4">
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body text-center">
                                                        <div id="picture0" style="width: 100%; height: 100%;">
                                                            <asp:Image ID="imgPortico" runat="server" Width="290px" Height="220px" />
                                                        </div>
                                                        <div id="picture1" class="form-horizontal" role="form">
                                                            ...
                                                            <hr />
                                                            <div class="form-group">
                                                                <div id="graphicsColumns0" class="text-center" style="width: 100%; height: 100%;">
                                                                    <asp:Image ID="imgColumn" runat="server" ImageUrl="../../imagenes/ESQUEMA%20COLUMNA-EN.jpg" Width="290px" Height="177px" />
                                                                </div>
                                                                <div id="graphicsColumns1" class="text-center" style="width: 100%; height: 100%;">
                                                                    <asp:Image ID="Image5" runat="server" ImageUrl="../../imagenes/CORTE%20COLUMNA.jpg" Width="290px" Height="177px" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div id="picture2" class="form-horizontal" role="form">
                                                            <div class="form-group">
                                                                <div class="col-sm-3"></div>
                                                                <div class="col-sm-6">
                                                            ...
                                                            <hr />
                                                            <div class="form-group">
                                                                <div id="graphicsBeams0" class="text-center" style="width: 100%; height: 100%;">
                                                                    <asp:Image ID="imgViga" runat="server" ImageUrl="../../imagenes/ESQUEMA%20VIGA-EN.jpg" Width="290px" Height="177px" />
                                                                </div>
                                                                <div id="graphicsBeams1" class="text-center" style="width: 100%; height: 100%;">
                                                                    <asp:Image ID="Image4" runat="server" ImageUrl="../../imagenes/CORTE%20VIGA.jpg" Width="290px" Height="177px" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-content" style="width: 100%; height: 400px;">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal" role="form">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="col-sm-2">
                                                                            <asp:TextBox ID="txtBaseC1" runat="server" class="form-control"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal" role="form">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <label class="col-sm-2 small text-center">Beam1</label>
                                                                        <label class="col-sm-2 small text-center">Beam2</label>
                                                                        <label class="col-sm-2 small text-center">Beam3</label>
                                                                        <label class="col-sm-2 small text-center">Beam4</label>
                                                                        <label class="col-sm-2 small text-center"></label>
                                                                        <label class="col-sm-2 small text-center"></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                    ...
                                                    <div class="tab-pane" id="test4">
                                                        <div class="col-md-7">
                                                            <div class="form-horizontal" role="form">
                                                                <div class="form-group">
                                                                    <asp:Label ID="lblFc" runat="server" class="col-sm-8 control-label small label-one"></asp:Label>
                                                                    <div class="col-sm-3">
                                                                        <asp:TextBox ID="txtFc" runat="server" class="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <asp:Label ID="lblFy" runat="server" class="col-sm-8 control-label small label-one"></asp:Label>
                                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-horizontal" role="form">
                                                                ...
                                                                <hr />
                                                                <div class="form-group">
                                                                    <div id="graphicsMP0" class="col-sm-11">
                                                                        <asp:Image ID="imgMP1" runat="server" Width="290px" Height="190px" />
                                                                    </div>
                                                                    <div id="graphicsMP1" class="col-sm-11">
                                                                        <asp:Image ID="imgMP2" runat="server" Width="290px" Height="190px" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="test5">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div id="chart-line" style="width: 100%; height: 100%;">
                                                                <chart:WebChartViewer ID="WebChartViewerPushover" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="290px" Height="240px" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- END TEST5 FORM -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4" style="border-right: 1.0pt solid #dddddd;">
                                                <div class="grid">
                                                    <div class="grid-header">
                                                        <i class="fa fa-bar-chart-o"></i>
                                                        <asp:Label ID="Label1" runat="server" class="grid-title lead" Text="ESQUEMA"></asp:Label>
                                                        <div class="pull-right grid-tools">
                                                        </div>
                                                    </div>
                                                    <div class="grid-body text-center">
                                                        <div id="chart-line" style="width: 100%; height: 270px;">
                                                            <asp:Image ID="imgPortico2" runat="server" Width="290px" Height="220px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="grid">
                                                    ...
                                                    <div class="grid-body" style="height: 305px;">
                                                        <div class="form-horizontal" role="form">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 text-center">
                                                                    <div id="graphics0" class="col-sm-10">
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-4 text-right" style="padding-top: 70px;">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam1" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart21" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam2" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart31" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam3" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart41" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam11" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart22" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam22" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart32" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam33" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart42" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam111" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart23" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam222" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart33" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam333" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart43" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam1111" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart24" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam2222" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart34" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRBeam3333" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChart44" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div id="collapse3" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn0" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC11" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn1" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC21" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn2" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC31" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn3" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC41" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn00" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC12" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn11" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC22" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn22" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC32" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn33" class="col-sm-12 text-center">
                                                                                <chart:WebChartViewer ID="WebChartC42" runat="server" style="position: static" BorderColor="White" SelectionBorderColor="Transparent" Width="250px" Height="220px" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div id="collapse4" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn000" class="col-sm-12 text-center">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn111" class="col-sm-12 text-center">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn222" class="col-sm-12 text-center">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn333" class="col-sm-12 text-center">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn0000" class="col-sm-12 text-center">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn1111" class="col-sm-12 text-center">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn2222" class="col-sm-12 text-center">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div id="graphicsRColumn3333" class="col-sm-12 text-center">

...
function ase_9(id){return document.getElementById?document.getElementById(id):document.all[id];}
function ase_a(e,la,lb,lc,ld){if(window.event)return window.event[la]+((document.documentElement&&document.documentElement[lb])||document.body[lb]);else return(typeof e[lc]!='undefined')?e[lc]:e[la]+window[ld];}
function ase_b(e){return ase_a(e,"clientX","scrollLeft","pageX","scrollX")+ase_7;}
function ase_c(e){return ase_a(e,"clientY","scrollTop","pageY","scrollY")+ase_7;}
function ase_d(e){if(ase_6&&window.event)return window.event.button;else return(e.which==3)?2:e.which;}
function ase_e(le,lf){return le?le[lf]+ase_e(le.offsetParent,lf):0;}
function ase_f(le){return ase_e(le,"offsetLeft")+(le.offsetWidth-le.clientWidth)/2;}
function ase_g(le){return ase_e(le,"offsetTop")+(le.offsetHeight-le.clientHeight)/2;}
function ase_h(lg,lh){return lg+((lg.indexOf('?')!=-1)?'&':'?')+lh;}
function ase_i(li,lj,lk){var re=new RegExp(lj,'g');return li.replace(re,lk);}
function ase_j(lm){var ln=document.scripts;if(((!ln)||(!ln.length))&&document.getElementsByTagName)ln=document.getElementsByTagName("script");if(ln){for(var i=0;i<ln.length;++i){var lp=ln[i].src;if(!lp)continue;var lq=lp.indexOf(lm);if(lq!=-1)return lp.substring(0,lq);}
}
return "";}
function ase_k(lr,ls,lt){var lu=lr.indexOf(ls);var lv=lr.indexOf(lt);if((lu<0)||(lv<=lu))return '';else return lr.substring(lu+ls.length,lv);}
function ase_l(lr,lw){var lq=lr.indexOf(lw);return(lq>=0)?lr.substring(0,lq):lr;}
function ase_m(lr,lw){var lq=lr.indexOf(lw);return(lq>=0)?lr.substring(lq+1,lr.length):"";}
function ase_n(v){return ase_i(ase_i(v,'&','&amp;'),'"','&#34;');}
function ase_o(n){n.onload=n.onerror=n.src='';var p=n.parentNode||n.parentElement;if(p&&p.removeChild)p.removeChild(n);else if(n.outerHTML)n.outerHTML='';}
function ase_p(f){var f2=frames[f.id];if(f2){var d2=f2.contentDocument||f2.document;if(d2)return d2.body.innerHTML;}
return null;}
function ase_AJAX_frame_loaded(f){if(f.lx1)return;var l31=ase_p(f);if(null!=l31)f.lh1(l31);ase_o(f);}
function ase_AJAX_frame_error(f){if(f.li1)f.li1(700,ase_p(f));ase_o(f);}
function ase_q(lg,l41,l51){var f=null;var l61="ase_AJAX_frame_"+(new Date().getTime());if(ase_6&&(ase_8()>=5.5)){document.body.insertAdjacentHTML('AfterBegin',"<IFRAME NAME='"+l61+"' ID='"+l61+"' style='display:none' onload='ase_AJAX_frame_loaded(this)' onerror='ase_AJAX_frame_error(this)'></IFRAME>");f=ase_9(l61);}
if(!f){if(l51)l51(600,"Cannot create IFRAME '"+l61+"'");return null;}
var f2=frames[f.id];var d2=f2.contentDocument||f2.document;f.lx1=true;d2.open();d2.write('<html><body><form name="ase_form" method="'+((lg.length<1000)?'get':'post')+'" action="'+ase_n(ase_l(lg,"?"))+'">');var l71=ase_m(lg,"?").split("&");for(var i=0;i<l71.length;++i){d2.write('<input type="hidden" name="'+ase_n(ase_l(l71[i],"="))+'" value="'+ase_n(unescape(ase_m(l71[i],"=")))+'">');}
d2.write('</form></body></html>');d2.close();f.lx1=false;f.lh1=l41;f.li1=l51;d2.forms['ase_form'].submit();return{'abort':function(){ase_o(f);}};}
function ase_r(){if(typeof XMLHttpRequest!='undefined')return new XMLHttpRequest();
/*@cc_on
...
function ase_s(lg,l41,l51){var r=ase_r();if(r){r.onreadystatechange=function(){if(r.readyState==4){var status=-9999;eval("try { status = r.status; } catch(e) {}");if(status==-9999)return;if((r.status==200)||(r.status==304))l41(r.responseText);else if(l51)l51(r.status,r.responseText);window.setTimeout(function(){r.onreadystatechange=function(){};r.abort();},1);}
}
if((lg.length<1000)||(ase_5&&!r.setRequestHeader)){r.open('GET',lg,true);r.send(null);}
else {r.open('POST',ase_l(lg,"?"),true);r.setRequestHeader("Content-Type","application/x-www-form-urlencoded");r.send(ase_m(lg,"?"));}
return r;}
return ase_q(lg,l41,l51);}
function _jcv(v){this.lr=v.id;v.lc2=v.useMap;this.lp1=v.style.cursor;this.lr1(v);this.lo={};var la1=v.id+"_JsChartViewerState";this.lu1=ase_9(la1);if(!this.lu1){var p=v.parentNode||v.parentElement;if(p&&p.insertBefore){var s=this.lu1=document.createElement("HIDDEN");s.id=s.name=la1;s.value=this.la1();p.insertBefore(s,v);}
else if(v.insertAdjacentHTML){v.insertAdjacentHTML("AfterEnd","<HIDDEN id='"+la1+"' name='"+la1+"'>");this.lu1=ase_9(la1);if(this.lu1)this.lu1.value=this.la1();else this.lu1={"name":la1,"id":la1,"value":this.la1()};}
}
else this.decodeState(this.lu1.value);this.ls1();if(!ase_6)this.l11(this.lw1());if(this.ln)this.partialUpdate();}
_jcvp=_jcv.prototype;_jcv.l22=function(ld1){var le1=window.cdjcv_path;if(typeof le1=="undefined")le1=ase_j("cdjcv.js");else if((le1.length>0)&&("/=".indexOf(le1.charAt(le1.length-1))==-1))le1+='/';return le1+ld1;}
_jcv.Horizontal=0;_jcv.Vertical=1;_jcv.HorizontalVertical=2;_jcv.Default=0;_jcv.Scroll=2;_jcv.ZoomIn=3;_jcv.ZoomOut=4;_jcv.msgContainer='<div style="font-family:Verdana;font-size:8pt;font-weight:bold;padding:3 8 3 8;border:1pt solid #000000;background-color:#FFCCCC;color:#000000">%msg</div>';_jcv.okButton='<center>[<a href="javascript:%closeScript"> OK </a>]</center>';_jcv.xButton='[<a href="javascript:%closeScript"> X </a>]';_jcv.shortErrorMsg='Error %errCode accessing server'+_jcv.okButton;_jcv.serverErrorMsg=_jcv.xButton+'<div style="font-family:Arial; font-weight:bold; font-size:15pt;">Error %errCode accessing server</div><hr>%errMsg';_jcv.updatingMsg='<div style="padding:0 8 0 6;background-color:#FFFFCC;color:#000000;border:1px solid #000000"><table><tr><td><img src="'+_jcv.l22('wait.gif')+'"></td><td style="font-size:8pt;font-weight:bold;font-family:Verdana">Updating</td></tr></table></div>';_jcv.lj1=new Array("l0","l1","l2","l3","l4","l5","l6","l7","l8","l9","la","lb","lc","ld","le","lf","lg","lh","li","lj","lk","ll","lm","ln","lo","lp","lq");_jcv.get=function(id){var imgObj=ase_9(id);if(!imgObj)return null;if(!imgObj._jcv)imgObj._jcv=new _jcv(imgObj);return imgObj._jcv;}
_jcvp.getId=function(){return this.lr;}
_jcvp.lt1=function(){return ase_9(this.lr);}
_jcvp.lr1=function(){this.lt1().ly=function(e,id){var lg1;if(!this._jcv.lm1)lg1=this._jcv["onImg"+id](e);if(this["_jcvOn"+id+"Chain"])lg1=this["_jcvOn"+id+"Chain"](e);return lg1;};this.lt1()._jcvOnMouseMoveChain=this.lt1().onmousemove;this.lt1()._jcvOnMouseUpChain=this.lt1().onmouseup;this.lt1()._jcvOnMouseDownChain=this.lt1().onmousedown;var lh1=this.lr;this.lt1().onmousemove=function(e){return ase_9(lh1).ly(e,"MouseMove");}
this.lt1().onmousedown=function(e){return ase_9(lh1).ly(e,"MouseDown");}
this.lt1().onmouseup=function(e){return ase_9(lh1).ly(e,"MouseUp");}
}
_jcvp.lq2=function(x){return x-ase_f(this.lt1());}
_jcvp.lr2=function(y){return y-ase_g(this.lt1());}
_jcvp.lp2=function(w){return w;}
_jcvp.lo2=function(h){return h;}
_jcvp.lm2=function(x){return x+ase_f(this.lt1());}
_jcvp.ln2=function(y){return y+ase_g(this.lt1());}
...
_jcvp.msgBox=function(ln1,lo1){var m=this.l21;if(!m&&ln1){var d=document;if(d.body.insertAdjacentHTML){var lr1='msg_'+this.lr;d.body.insertAdjacentHTML("BeforeEnd","<DIV ID='"+lr1+"' style='position:absolute;visibility:hidden;'></DIV>");m=ase_9(lr1);}
else if(d.createElement){m=d.createElement("DIV");m.style.position='absolute';m.style.visibility='hidden';d.body.appendChild(m);}
if(m)this.l21=m;}
if(m){window.clearTimeout(m.l31);var s=m.style;if(ln1){if(lo1)m.l31=window.setTimeout(function(){s.visibility='hidden';},Math.abs(lo1));if(lo1<0)ln1+=_jcv.okButton;if(ln1.substring(0,4).toLowerCase()!="<div")ln1=ase_i(_jcv.msgContainer,'%msg',ln1);var ls1="_jcv.get('"+this.lr+"').msgBox();";m.innerHTML=ase_i(ln1,'%closeScript',ls1);s.visibility='visible';s.left=this.lm2(Math.max(0,this.l0+(this.l2-m.offsetWidth)/2));s.top=this.ln2(Math.max(0,this.l1+(this.l3-m.offsetHeight)/2));}
...
_jcvp.l62=function(id){var d=document;if(d.body.insertAdjacentHTML){d.body.insertAdjacentHTML("BeforeEnd","<DIV ID='"+id+"' style='position:absolute;visibility:hidden;background-color:#000000;width:1px;height:1px;'><IMG WIDTH='1' HEIGHT='1'></DIV>");var lg1=ase_9(id);if(ase_6&&(ase_8()<5.5))lg1.onmousemove=_jcvp_false_function;return lg1;}
...
_jcvp.setMouseUsage=function(l12){this.la=l12;this.lf2();this.le2();}
...
_jcvp.l41=function(e,d){var l62=Math.abs(ase_b(e)-this.ls2);var l72=Math.abs(ase_c(e)-this.lt2);switch(d){case _jcv.Horizontal:return l62>=this.lj;case _jcv.Vertical:return l72>=this.lj;default:return(l62>=this.lj)||(l72>=this.lj);}
}
_jcvp.onImgMouseDown=function(e){if(this.l01(ase_b(e),ase_c(e))&&(ase_d(e)==1)){if(e&&e.preventDefault&&(this.la!=_jcv.Default))e.preventDefault();this.ld2(true);this.ls(e);}
}
_jcvp.onImgMouseMove=function(e){if(this.l12&&window.event&&(ase_d(e)!=1)){this.ld2(false);this.l02=false;this.ll1(false);}
this.lz1=this.l12||this.l01(ase_b(e),ase_c(e));if(this.lz1){this.lu(e);if(this.l12){if((this.la!=_jcv.Default)&&this.lt1().useMap)this.lt1().useMap=null;this.lt(e);}
}
this.l11(this.lz(e));return this.la==_jcv.Default;}
_jcvp.onImgMouseUp=function(e){if(this.l12&&(ase_d(e)==1)){this.ld2(false);this.lv(e);}
}
...
_jcvp.lz=function(e){if(this.lm1)return "wait";if(this.l02){if(this.lm)return this.lm;switch(this.lb){case _jcv.Horizontal:return(ase_b(e)>=this.ls2)?"e-resize":"w-resize";case _jcv.Vertical:return(ase_c(e)>=this.lt2)?"s-resize":"n-resize";default:return "move";}
}
...
this.l02=false;}
_jcvp.lg1=function(e,lh2){var eX=ase_b(e);var eY=ase_c(e);var li2=this.l6/lh2;var lj2=this.l7/lh2;this.l71(this.lc,(this.lq2(eX)-this.l0)*this.l6/this.l2-li2/2,li2,(this.lr2(eY)-this.l1)*this.l7/this.l3-lj2/2,lj2);}
_jcvp.lf1=function(e){var eX=ase_b(e);var eY=ase_c(e);this.l71(this.lb,this.l6*this.lp2(this.ls2-eX)/this.l2,this.l6,this.l7*this.lo2(this.lt2-eY)/this.l3,this.l7);}
_jcvp.le1=function(e){var eX=ase_b(e);var eY=ase_c(e);var li2=this.l6*this.lp2(Math.abs(this.ls2-eX))/this.l2;var lj2=this.l7*this.lo2(Math.abs(this.lt2-eY))/this.l3;this.l71(this.lc,this.l6*(this.lq2(Math.min(this.ls2,eX))-this.l0)/this.l2,li2,this.l7*(this.lr2(Math.min(this.lt2,eY))-this.l1)/this.l3,lj2);}
...
_jcvp.applyHandlers=function(lq2){var lg1=false;var a=this.lo1(lq2);for(var i in a){this.lu2=a[i];if(this.lu2!=null)lg1|=this.lu2();}
this.lu2=null;return lg1;}
_jcvp.partialUpdate=function(){if(this.lm1)return;_jcv.ld1(this.lt1());this.applyHandlers("preupdate");this.ln=1;this.le2();var lt2=this.updatingMsg;if(!lt2)lt2=_jcv.updatingMsg;if(lt2&&(lt2!="none"))this.msgBox(lt2);var lg=ase_h(ase_9(this.lr+"_callBackURL").value,"cdPartialUpdate="+this.lr+"&cdCacheDefeat="+(new Date().getTime())+"&"+this.lu1.name+"="+escape(this.lu1.value));var lu2=this;this.lm1=true;ase_s(lg,function(t){lu2.l42(t)},function(lw2,lx2){lu2.lx(lw2,lx2);});}
_jcvp.l42=function(lr){var ly2=ase_k(lr,"<!--CD_SCRIPT "," CD_SCRIPT-->");if(ly2){var lz2=ase_k(lr,"<!--CD_MAP "," CD_MAP-->");var imgObj=this.lt1();var imgBuffer=this.l61=(this.doubleBuffering)?new Image():imgObj;if(imgObj.useMap)imgObj.useMap=null;imgObj.loadImageMap=function(){window.setTimeout(function(){_jcv.putMap(imgObj,lz2);},100);};imgBuffer.onload=function(){imgObj._jcv.onPartialLoad(true);}
...
_jcvp.lw=function(l23){var imgObj=this.lt1();var imgBuffer=this.l61;if(imgBuffer)imgBuffer.onerror=imgBuffer.onabort=imgBuffer.onload='';imgObj.onUpdateCompleted='';this.lm1=false;if(l23){if(imgObj!=imgBuffer){imgObj.src=imgBuffer.src;imgObj.style.width=imgBuffer.style.width;imgObj.style.height=imgBuffer.style.height;}
imgObj.loadImageMap();}
...
_jcvp.lx=function(lw2,lx2){this.lw(false);this.msgBox();this.errCode=lw2;this.errMsg=lx2;if(!this.applyHandlers("updateerror")){var l33=this.serverErrorMsg;if(!l33)l33=_jcv.serverErrorMsg;if(l33&&(l33!="none"))this.msgBox(ase_i(ase_i(l33,'%errCode',lw2),'%errMsg',lx2));}
...
l63.src=ase_h(this.l32,"cdDirectStream="+this.lr+"&cdCacheDefeat="+l53);return true;}
...
return lg1;}
_jcvp.decodeState=function(s){var l71=s.split("\x1e");for(var i=0;i<l71.length;++i){var av=this.l81(l71[i]);if(!av)continue;var a=_jcv.lj1[parseInt(av.attr)];if(a=="lo"){var l83=av.value.split("\x1f");for(var i2=0;i2<l83.length;++i2){var la3=this.l81(l83[i2]);this.lo[la3.attr]=la3.value;}
}
else this[a]=av.value;}
this.lp=0;}
_jcvp.le2=function(){if(this.lu1)this.lu1.value=this.la1();}
_jcvp.ls1=function(){if(!ase_6){var imgObj=this.lt1();var m=_jcv.ln1(imgObj);if(m){m.onmousedown=imgObj.onmousedown;m.onmousemove=imgObj.onmousemove;if(ase_2&&document.createElement){var a=this.lb2=document.createElement("AREA");a.coords=""+this.l0+","+this.l1+","+(this.l0+this.l2)+","+(this.l1+this.l3);a.shape="rect";a.onclick="return false;";m.appendChild(a);m.ly1=a;this.lf2();}
}
}
}
_jcv.ln1=function(imgObj){var lb3=imgObj.lc2;if(!lb3)lb3=imgObj.useMap;if(!lb3)return null;var lq=lb3.indexOf('#');if(lq>=0)lb3=lb3.substring(lq+1);return ase_9(lb3);}
_jcv.loadMap=function(imgObj,lg){if(!imgObj.lc2)imgObj.lc2=imgObj.useMap;_jcv.ld1(imgObj);imgObj.lv1=ase_s(lg,function(t){_jcv.putMap(imgObj,ase_k(t,"<!--CD_MAP "," CD_MAP-->"));},function(lw2,lx2){_jcv.onLoadMapError(lw2,lx2);}
);}
_jcv.loadPendingMap=function(){if(!window._jcvPendingMap)return;for(var a in window._jcvPendingMap){var le=ase_9(a);if(le){var lg=window._jcvPendingMap[a];window._jcvPendingMap[a]=null;if(lg)_jcv.loadMap(le,lg);}
}
}
_jcv.ld1=function(imgObj){if(imgObj.lv1){imgObj.lv1.abort();imgObj.lv1=null;}
}
_jcv.onLoadMapError=function(lw2,lx2){}
_jcv.putMap=function(imgObj,lc3){var m=_jcv.ln1(imgObj);if(!m&&lc3){var lb3='map_'+imgObj.id;imgObj.useMap=imgObj.lc2='#'+lb3;var d=document;if(d.body.insertAdjacentHTML){d.body.insertAdjacentHTML("BeforeEnd","<MAP ID='"+lb3+"'></MAP>");m=ase_9(lb3);}
...
imgObj.lv1=null;}
_jcv.canSupportPartialUpdate=function(){return((ase_6&&(ase_8()>=5.5))||window.XMLHttpRequest||ase_r());}
